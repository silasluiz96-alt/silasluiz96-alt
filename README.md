...
| 🎓 [EduSynth](https://github.com/silasluiz96-alt/EduSynth) | Multi-agent AI study assistant for ENEM — Generative AI in production | `Python` `Groq` `Streamlit` `Multi-Agent` |
